 ...
 */
async function sendEmail(mailOptions: any): Promise<boolean> {
...
export const sendOTPEmailDirect = async (email: string, otp: string): Promise<boolean> => {
  const mailOptions = {
...
export const sendEditorNotificationEmailDirect = async (
  articleData: any,
  pdfPath?: string,
  editorEmails?: string[]
): Promise<boolean> => {
...
export const sendUserSubmissionConfirmationEmailDirect = async (
  userEmail: string,
  articleData: any
): Promise<boolean> => {
  const mailOptions = {
