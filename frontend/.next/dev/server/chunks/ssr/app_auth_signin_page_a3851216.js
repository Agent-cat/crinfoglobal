module.exports = [
"[project]/app/auth/signin/page.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const SigninPage = ()=>{
    ...
    const handleSubmit = async (e)=>{
        ...
        setError(null);
        try {
            const userData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$api$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["signin"])(email, password);
            __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$authEvents$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].dispatch('loginSuccess', userData);
            router.push("/");
            router.refresh();
        } catch (error) {
...
//# sourceMappingURL=app_auth_signin_page_a3851216.js.map