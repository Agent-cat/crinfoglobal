...
"[project]/node_modules/citeproc/citeproc_commonjs.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var CSL = {
    ...
    checkSuffixSpacePrepend: function(state, suffix) {
        ...
        if (suffix.match(CSL.STARTSWITH_ROMANESQUE_REGEXP) || [
            '[',
            '('
    ...
    EVALUATE_GROUP_CONDITION: function(state, flags) {
        ...
        if (flags.condition.test === "empty-label") {
        ...
        ].indexOf(flags.condition.test) > -1) {
            ...
            if (num) {
                if (flags.condition.valueTerm) {
                    ...
                    "always",
                    "after-number"
                ].indexOf(state.opt.require_comma_on_symbol) > -1) {
                    testres = true;
                } else {
                    testres = false;
                }
    ...
    TITLE_SPLIT: function(str) {
        ...
        for(var i = lst.length - 2; i > -1; i--){
            ...
            if (lst[i] && lst[i].slice(-1).toLowerCase() !== lst[i].slice(-1)) {
                ...
                // merge
                lst = lst.slice(0, i + 1).concat([
                    m[i]
                ]).concat(lst.slice(i + 1));
            }
        }
        return lst;
    },
    ...
    INIT_JURISDICTION_MACROS: function(state, Item, item, macroName) {
        ...
        if (!state.opt.jurisdictions_seen[jurisdictionList[0]]) {
            ...
            for(var jurisdiction in res){
                ...
                if (fallback) {
                    if (!res[fallback]) {
                        Object.assign(res, state.retrieveAllStyleModules([
                            fallback
                        ]));
...
CSL.XmlJSON.prototype.insertChildNodeAfter = function(parent, node, pos, datejson) {
    ...
    for(var i = 0, ilen = parent.children.length; i < ilen; i += 1){
        if (node === parent.children[i]) {
            parent.children = parent.children.slice(0, i).concat([
                datejson
...
CSL.XmlJSON.prototype.addInstitutionNodes = function(myjson) {
    ...
    if (myjson.name === "names") {
        ...
        if (insertPos > -1) {
            ...
            myjson.children = myjson.children.slice(0, insertPos + 1).concat([
                institution
 ...
 */ CSL.parseXml = function(str) {
    ...
    function processElement(elem) {
        ...
        if (elem.slice(1).indexOf('<') > -1) {
            ...
            obj.children = [
                _extractTextFromCompositeElement(elem)
            ];
...
CSL.XmlDOM.prototype.setAttribute = function(myxml, attr, val) {
    ...
    if ([
        "function",
        "unknown"
    ].indexOf(typeof myxml.setAttribute) > -1) {
...
/*global CSL: true */ CSL.setupXml = function(xmlObject) {
    var dataObj = {};
    var parser = null;
...
/*global CSL: true */ CSL.getSortCompare = function(default_locale) {
...
/*global CSL: true */ CSL.ambigConfigDiff = function(a, b) {
...
/*global CSL: true */ /* For node execution pretty-printing (see below) */ /*
var INDENT = "";
...
/*global CSL: true */ CSL.DateParser = function() {
    /*
     * Fixed values
     */ // jse imperial years
    var epochPairs = [
...
/*global CSL: true */ CSL.Engine = function(sys, style, lang, forceLang) {
    var attrs, langspec;
                ...
                if (!item.locator) {
                    ...
                    if (m) {
                        ...
                        if ([
                            ...
                            ":",
                            "?"
                        ].indexOf(item.locator.slice(0, 1)) > -1) {
                            space = "";
                        }
                    } else {
                        space = "";
...
CSL.Engine.prototype.setNumberLabels = function(Item) {
    if (Item.number && [
        ...
        "regulation",
        "treaty"
    ].indexOf(Item.type) > -1 && this.opt.development_extensions.consolidate_legal_items && !this.tmp.shadow_numbers["number"]) {
        ...
        if (firstlabel) {
            ...
            this.tmp.shadow_numbers["number"].values.push([
                "Blob",
                value,
                false
            ]);
...
/*global CSL: true */ CSL.substituteOne = function(template) {
...
/*global CSL: true */ CSL.Engine.prototype.getCitationLabel = function(Item) {
    var label = "";
...
/*global CSL: true */ CSL.Engine.prototype.setOutputFormat = function(mode) {
    this.opt.mode = mode;
...
/*global CSL: true */ CSL.Engine.Opt = function() {
    this.parallel = {
        enable: false
...
/*global CSL: true */ CSL.Engine.prototype.previewCitationCluster = function(citation, citationsPre, citationsPost, newMode) {
    ...
    for(var i = 0, ilen = citation.citationItems.length; i < ilen; i += 1){
        ...
        if (this.opt.development_extensions.locator_label_parse) {
            if (item.locator && [
                ...
                "regulation",
                "treaty"
            ].indexOf(Item.type) === -1 && (!item.label || item.label === 'page')) {
...
CSL.Engine.prototype.process_CitationCluster = function(sortedItems, citation) {
    ...
    if (citation && citation.properties && citation.properties.mode === "composite") {
        ...
        if (firstChunk && secondChunk && CSL.SWAPPING_PUNCTUATION.concat([
            "\u2019",
            "\'"
        ]).indexOf(secondChunk[0]) > -1) {
 ...
 */ CSL.getCitationCluster = function(inputList, citation) {
    ...
    for(pos = 0; pos < len; pos += 1){
        ...
        if (pos > 0) {
            ...
            var precedingEndsInPeriodOrComma = preceding_item.suffix && [
                ";",
                ".",
                ","
            ].indexOf(preceding_item.suffix.slice(-1)) > -1;
            var currentStartsWithPeriodOrComma = !preceding_item.suffix && item.prefix && [
                ";",
                ".",
                ","
    ...
    for(pos = 0, len = myblobs.length; pos < len; pos += 1){
        ...
        if (buffer.length > 1 && typeof buffer[0] !== "string") {
            buffer = [
                this.output.renderBlobs(buffer)
            ];
        }
        if (buffer.length) {
...
/*global CSL: true */ CSL.Engine.prototype.makeBibliography = function(bibsection) {
 ...
 */ CSL.getBibliographyEntries = function(bibsection) {
    ...
    for(i = 0, ilen = input.length; i < ilen; i += 1){
        ...
        bib_entry.decorations = [
            [
                "@bibliography",
                "entry"
            ]
        ].concat(this.bibliography.opt.layout_decorations);
...
/*global CSL: true */ CSL.Engine.prototype.setCitationId = function(citation, force) {
...
/*global CSL: true */ CSL.localeResolve = function(langstr, defaultLocale) {
    var ret, langlst;
    if (!defaultLocale) {
        defaultLocale = "en-US";
    }
...
CSL.Engine.prototype.localeConfigure = function(langspec, beShy) {
    ...
    if ("undefined" === typeof this.locale[langspec.best].terms["page-range-delimiter"]) {
        if ([
            "fr",
            "pt"
        ].indexOf(langspec.best.slice(0, 2).toLowerCase()) > -1) {
...
/*global CSL: true */ CSL.Node.choose = {
    build: function(state, target) {
        var func;
        if (this.tokentype === CSL.START) {
            //open condition
...
/*global CSL: true */ CSL.Node.citation = {
    build: function(state, target) {
        if (this.tokentype === CSL.START) {
        ...
        if (this.tokentype === CSL.END) {
            ...
            if (state.opt.grouped_sort && state.citation_sort.opt.sort_directions.length) {
                ...
                state.citation_sort.opt.sort_directions = [
                    firstkey
                ].concat(state.citation_sort.opt.sort_directions);
...
/*global CSL: true */ CSL.Node["#comment"] = {
...
/*global CSL: true */ CSL.Node["date-part"] = {
    build: function(state, target) {
...
/*global CSL: true */ CSL.Node["else-if"] = {
    //
...
/*global CSL: true */ CSL.Node["et-al"] = {
    build: function(state, target) {
...
/*global CSL: true */ CSL.Node.group = {
...
/*global CSL: true */ CSL.Node.institution = {
    build: function(state, target) {
        if ([
            CSL.SINGLETON,
            CSL.START
...
/*global CSL: true */ CSL.Node["institution-part"] = {
    build: function(state, target) {
        var func;
    ...
    build: function(state, target) {
        ...
        if (state.build.date_key) {
            if (state.build.area === "citation" && state.build.extension === "_sort") {
                ...
                state[state.build.area].opt.sort_directions.push([
                    -1,
                    1
                ]);
                func = function(state, Item) {
...
/*global CSL: true */ CSL.Node.label = {
    build: function(state, target) {
...
/*global CSL: true */ CSL.Node.layout = {
    build: function(state, target) {
        ...
        if (this.tokentype === CSL.START && !state.tmp.cite_affixes[state.build.area]) {
            ...
            func = function(state, Item, item) {
                ...
                if (state.opt.suppressedJurisdictions[Item["country"]] && Item["country"] && [
                    "treaty",
                    "patent"
                ].indexOf(Item.type) === -1) {
        ...
        if (this.tokentype === CSL.START) {
            ...
            if (!this.locale_raw) {
                ...
                //
                state[state.tmp.area].opt.topdecor = [
                    this.decorations
                ];
                state[state.tmp.area + "_sort"].opt.topdecor = [
                    this.decorations
                ];
...
/*global CSL: true */ CSL.Node.macro = {
    build: function() {}
};
/*global CSL: true */ CSL.Node.alternative = {
    build: function(state, target) {
        if (this.tokentype === CSL.START) {
            var choose_tok = new CSL.Token("choose", CSL.START);
            CSL.Node["choose"].build.call(choose_tok, state, target);
                ...
                if (Item["language-name"] && Item["language-name-original"]) {
                    ...
                    for(var key in newItem){
                        if ([
                            ...
                            "language",
                            "multi"
                        ].indexOf(key) === -1 && key.slice(0, 4) !== "alt-") {
...
/*global CSL: true */ CSL.NameOutput = function(state, Item, item) {
    this.debug = false;
    this.state = state;
    //SNIP-START
    if (this.debug) {
    ...
    for(i = 0, ilen = variables.length; i < ilen; i += 1){
        ...
        if (!this.state.opt.development_extensions.spoof_institutional_affiliations) {
            ...
            for(var j = 0, jlen = this.institutions[v].length; j < jlen; j += 1){
                institution_sets.push(this.joinPersonsAndInstitutions([
                    this.persons[v][j],
...
*/ /*global CSL: true */ CSL.NameOutput.prototype.isPerson = function(value) {
...
/*global CSL: true */ CSL.NameOutput.prototype.truncatePersonalNameLists = function() {
...
/*global CSL: true */ CSL.NameOutput.prototype.divideAndTransliterateNames = function() {
    var i, ilen, j, jlen;
    var Item = this.Item;
    var variables = this.variables;
...
/*global CSL: true */ CSL.NameOutput.prototype._purgeEmptyBlobs = function(blobs) {
...
/*global CSL: true */ CSL.NameOutput.prototype.checkCommonAuthor = function(requireMatch) {
    if (!requireMatch) {
        return false;
    }
...
/*global CSL: true */ CSL.NameOutput.prototype.constrainNames = function() {
...
/*global CSL: true */ CSL.NameOutput.prototype.disambigNames = function() {
    var pos;
    for(var i = 0, ilen = this.variables.length; i < ilen; i += 1){
        var v = this.variables[i];
        pos = this.nameset_base + i;
...
/*global CSL: true */ CSL.NameOutput.prototype.getEtAlConfig = function() {
    var item = this.item;
    this["et-al"] = {};
...
/*global CSL: true */ CSL.NameOutput.prototype.setEtAlParameters = function() {
    var i, ilen, j, jlen;
    for(i = 0, ilen = this.variables.length; i < ilen; i += 1){
        var v = this.variables[i];
...
/*global CSL: true */ CSL.NameOutput.prototype.renderAllNames = function() {
...
CSL.NameOutput.prototype._composeOneInstitutionPart = function(names, slot, style) {
    ...
    if (secondary || tertiary) {
        ...
        secondary_outer.decorations.push([
            "@font-style",
            "normal"
        ]);
        secondary_outer.decorations.push([
        ...
        tertiary_outer.decorations.push([
            "@font-style",
            "normal"
        ]);
        tertiary_outer.decorations.push([
...
CSL.NameOutput.prototype._renderOnePersonalName = function(value, pos, i, j) {
    ...
    if ([
        ...
        "ru",
        "cs"
    ].indexOf(this.state.opt["default-locale"][0].slice(0, 2)) > -1) {
        nbspace = "\u00a0";
    } else {
        nbspace = " ";
    }
    ...
    if (romanesque === 0) {
        ...
        if ([
            "always",
            "display-and-sort"
        ].indexOf(this.state.opt["demote-non-dropping-particle"]) > -1) {
        ...
        blob = this._join([
            given,
            second
        ], name["comma-dropping-particle"] + space);
    }
...
CSL.NameOutput.prototype.getStaticOrder = function(name, refresh) {
    ...
    if (!refresh && name["static-ordering"]) {
        ...
        static_ordering_val = true;
    } else if ((!name.multi || !name.multi.main) && this.Item.language && [
        'vi',
        'hu'
    ].indexOf(this.Item.language) > -1) {
        static_ordering_val = true;
    } else if (name.multi && name.multi.main && [
        'vi',
        'hu'
    ].indexOf(name.multi.main.slice(0, 2)) > -1) {
        static_ordering_val = true;
    } else {
...
/*global CSL: true */ CSL.PublisherOutput = function(state, group_tok) {
    this.state = state;
...
/*global CSL: true */ CSL.evaluateLabel = function(node, state, Item, item) {
    var myterm;
    ...
    if ("number" !== typeof plural) {
        ...
        if (theItem[node.strings.term]) {
            ...
            if ([
                ...
                "number",
                "page"
            ].indexOf(node.strings.term) > -1 && state.tmp.shadow_numbers[node.strings.term].label) {
...
/*global CSL: true */ CSL.Node["name-part"] = {
    build: function(state) {
        state.build[this.strings.name] = this;
    }
};
/*global CSL: true */ CSL.Node.names = {
    build: function(state, target) {
        var func;
        // CSL.debug = print;
        if (this.tokentype === CSL.START || this.tokentype === CSL.SINGLETON) {
...
/*global CSL: true */ CSL.Node.number = {
    build: function(state, target) {
        var func;
        CSL.Util.substituteStart.call(this, state, target);
        //
        ...
        func = function(state, Item, item) {
            ...
            if ([
                "locator",
                "locator-extra"
            ].indexOf(this.variables_real[0]) > -1 && !state.tmp.just_looking) {
...
/*global CSL: true */ CSL.Node.substitute = {
    build: function(state, target) {
        var func;
        if (this.tokentype === CSL.START) {
            /* */ // set conditional
        ...
        if (this.postponed_macro) {
            ...
            if ("citation-number" === this.variables_real[0] || "year-suffix" === this.variables_real[0] || "citation-label" === this.variables_real[0]) {
                ...
                if (this.strings.term) {
                    ...
                    if (CSL.MULTI_FIELDS.indexOf(this.variables_real[0]) > -1 || this.variables_real[0].indexOf("-main") > -1 || this.variables_real[0].indexOf("-sub") > -1 || [
                        "language-name",
...
/*global CSL: true */ CSL.Node.intext = {
    build: function(state, target) {
        if (this.tokentype === CSL.START) {
...
/*global CSL: true */ CSL.Attributes = {};
        ...
        func = function(state, Item, item) {
            ...
            for(var i = 0, ilen = this.variables.length; i < ilen; i++){
                ...
                if ([
                    "authority",
                    "committee"
                ].indexOf(variable) > -1 && "string" === typeof Item[variable] && "names" === this.name) {
...
CSL.Parallel.prototype.checkRepeats = function(params) {
    ...
    if (this.state.tmp.suppress_repeats) {
        if (params.parallel_first && Object.keys(params.parallel_first).length > 0) {
            var arr = [
                {}
            ].concat(this.state.tmp.suppress_repeats);
            var ret = true;
 ...
 */ CSL.Transform = function(state) {
    ...
    function abbreviate(state, tok, Item, altvar, basevalue, family_var, use_field) {
        ...
        if ([
            "jurisdiction",
            "country"
        ].indexOf(family_var) > -1 && basevalue === basevalue.toLowerCase()) {
...
/*global CSL: true */ CSL.Blob = function(str, token, levelname) {
    var len, pos, key;
...
/*global CSL: true */ CSL.Util.fixDateNode = function(parent, pos, node) {
...
/*global CSL: true */ CSL.dateMacroAsSortKey = function(state, Item) {
...
/*global CSL: true */ CSL.Util.Names = {};
 ...
 */ CSL.Util.Names.initializeWith = function(state, name, terminator, normalizeOnly) {
    ...
    if ([
        "Lord",
        "Lady"
    ].indexOf(name) > -1 || !name.replace(/^(?:<[^>]+>)*/, "").match(CSL.STARTSWITH_ROMANESQUE_REGEXP) && !terminator.match("%s")) {
        return name;
    }
...
/*global CSL: true */ CSL.Util.substituteStart = function(state, target) {
...
CSL.Util.substituteEnd = function(state, target) {
                    ...
                    if ("partial-each" === subrule || "partial-first" === subrule) {
                        ...
                        for(i = 0, ilen = state.tmp.name_node.children.length; i < ilen; i += 1){
                            ...
                            if (dosub && state.tmp.last_rendered_name && state.tmp.last_rendered_name.length > i - 1 && name && !name.localeCompare(state.tmp.last_rendered_name[i])) {
                                ...
                                state.tmp.name_node.children[i].blobs = [
                                    str
                                ];
                        ...
                        if (rendered_name) {
                            if (state.tmp.last_rendered_name && !rendered_name.localeCompare(state.tmp.last_rendered_name)) {
                                ...
                                if (state.tmp.label_blob) {
                                    state.tmp.name_node.top.blobs = [
                                        str,
                                        state.tmp.label_blob
                                    ];
                                } else if (state.tmp.name_node.top.blobs.length) {
                                    state.tmp.name_node.top.blobs[0].blobs = [
                                        str
                                    ];
                                } else {
                                    state.tmp.name_node.top.blobs = [
    ...
    if ("text" === this.name && !this.postponed_macro || [
        "number",
        "date",
        "names"
    ].indexOf(this.name) > -1) {
...
/*global CSL: true */ CSL.Util.padding = function(num) {
...
CSL.Engine.prototype.processNumber = function(node, ItemObject, variable) {
    ...
    function composeNumberInfo(origLabel, label, val, joiningSuffix, parsePosition) {
        ...
        if (label) {
            ...
            if (realVariable === "page" && parsePosition === 0 && [
                "p.",
                "pp."
            ].indexOf(m[2]) === -1) {
    ...
    function parseString(str, defaultLabel) {
        ...
        for(var i = 0, ilen = elems.length; i < ilen; i += 2){
            ...
            if (m) {
                ...
                if (m.length > 0) {
                    var slug = m[0].trim();
                    var notAlabel = !CSL.STATUTE_SUBDIV_STRINGS[slug] || "undefined" === typeof me.getTerm(CSL.STATUTE_SUBDIV_STRINGS[slug]) || [
                        "locator",
                        "number",
                        "locator-extra",
                        "page"
                    ].indexOf(variable) === -1 && CSL.STATUTE_SUBDIV_STRINGS[slug] !== variable;
                    if (notAlabel) {
                        if (i === 0) {
                            m = m.slice(1);
        ...
        if (values.length) {
            ...
            if (!me.tmp.just_looking) {
                if (values[0].value.slice(0, 1) === "\"" && values[values.length - 1].value.slice(-1) === "\"") {
                    ...
                    masterStyling.decorations.push([
                        "@quotes",
                        true
                    ]);
                }
...
/*global CSL: true */ CSL.Util.PageRangeMangler = {};
...
/*global CSL: true */ // Use a state machine
// Okay, good!
// Needs some tweaks:
...
CSL.Util.FlipFlopper = function(state) {
    ...
    if (localeOpenQuote && localeCloseQuote && [
        " \"",
        " \'",
        "\"",
        "\'"
    ...
    if (localeOpenInnerQuote && localeCloseInnerQuote && [
        " \"",
        " \'",
        "\"",
        "\'"
    ...
    var TagReg = function(blob) {
        ...
        this.set = function(tag) {
            ...
            if (!decor) {
                decor = [
                    attr,
                    _nestingData[tag].outer
                ];
            } else {
                decor = [
                    attr,
                    _nestingData[tag].flipflop[decor[1]]
                ];
            }
            _stack.push(decor);
        };
                        ...
                        for(var i = allTheDecor.length - 1; i > -1; i--){
                            ...
                            for(var j = _decorset.length - 1; j > -1; j--){
                                ...
                                if ([
                                    ...
                                    "@font-style",
                                    "@font-variant"
                                ].indexOf(_olddecor[0]) > -1 && !seen[_olddecor[0]]) {
                                    if (decor[1] !== "normal") {
                                        newblob.decorations.push([
                                            _olddecor[0],
                                            "normal"
                                        ]);
                                        newdecorset.push([
...
/*global CSL: true */ CSL.Output.Formatters = function() {
...
/*global CSL: true */ CSL.Registry.NameReg = function(state) {
            ...
            for(fullkey in this.nameind[id]){
                if (this.nameind[id].hasOwnProperty(fullkey)) {
                    ...
                    if (skey && this.namereg[pkey].ikey[ikey] && this.namereg[pkey].ikey[ikey].skey[skey]) {
                        ...
                        if (posB > -1) {
                            this.namereg[pkey].ikey[ikey].skey[skey].items = myitems.slice(0, posB).concat(myitems.slice([
                                posB + 1
                            ]));
                        }
                    ...
                    if (ikey && this.namereg[pkey].ikey[ikey]) {
                        ...
                        if (posB > -1) {
                            ...
                            this.namereg[pkey].ikey[ikey].items = items.slice(0, posB).concat(items.slice([
                                posB + 1
                            ]));
                        }
                    ...
                    if (pkey) {
                        ...
                        if (posB > -1) {
                            ...
                            this.namereg[pkey].items = items.slice(0, posB).concat(items.slice([
                                posB + 1
                            ], items.length));
                        }
...
/*global CSL: true */ CSL.Registry.CitationReg = function() {
    this.citationById = {};
    this.citationByIndex = [];
};
/*global CSL: true */ CSL.Disambiguation = function(state) {
    this.state = state;
...
CSL.Disambiguation.prototype.initVars = function(akey) {
    ...
    if (myIds && myIds.length > 1) {
        myItemBundles.push([
            this.maxNamesByItemId[myItem.id],
            myItem
        ]);
...
CSL.ParticleList = function() {
    ...
    var PARTICLES = [
        ...
        [
            "de la",
            non_dropping_2_alt_dropping_1_non_dropping_1
        ],
        [
            "de las",
            non_dropping_2_alt_dropping_1_non_dropping_1
...
//# sourceMappingURL=node_modules_citeproc_citeproc_commonjs_c8b693f4.js.map