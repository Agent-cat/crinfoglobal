...
const PublishedArticlesPage = ()=>{
    ...
    if ($[0] !== "4e37bf81c0cff41d1e7a7e9369053aebdbd92df3730ad8f7f7fc41dfff0a8e67") {
        for(let $i = 0; $i < 60; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "4e37bf81c0cff41d1e7a7e9369053aebdbd92df3730ad8f7f7fc41dfff0a8e67";
    }
    ...
    if ($[5] !== deleteArticleMutation || $[6] !== deleteConfirmation) {
        t4 = async ()=>{
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("articles");
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("latest-articles");
    ...
    if ($[9] !== editForm || $[10] !== editingArticle || $[11] !== updateArticleMutation) {
        t6 = async ()=>{
            ...
            try {
                ...
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("articles");
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("latest-articles");
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("article");
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])(`article-${editingArticle.id}`);
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$data$3a$d1c845__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["revalidateContent"])("volumes");
...
//# sourceMappingURL=_12ac166b._.js.map