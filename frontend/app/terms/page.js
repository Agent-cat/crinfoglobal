    ...
    <div className="min-h-screen text-black text-justify bg-white mt-16 py-8 px-5">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="space-y-4 leading-7">
          <p>
            For the purpose of these Terms and Conditions, the term "we", "us", "our" used anywhere on this page shall mean CrinfoGlobalPublishers, whose registered/operational office is Crinfo Global Publsihers, Kattur 641667 Pongalur SO TAMIL NADU 641667. "you", “your”, "user", “visitor” shall mean any natural or legal person who is visiting our website and/or agreed to purchase from us.
          </p>
          <p>
          ...
          <p>
            From time to time our website may also include links to other websites. These links are provided for your convenience to provide further information. You may not create a link to our website from another website or document without CrinfoGlobalPublishers’s prior written consent.
          </p>
          <p>
          ...
          <div className="mt-6 space-y-2">
            <a className="text-blue-700 underline" href="https://merchant.razorpay.com/policy/RP2W4HEunIurjq/terms" target="_blank" rel="noreferrer">Razorpay Terms</a>
          </div>
        </div>
      </div>
    </div>
