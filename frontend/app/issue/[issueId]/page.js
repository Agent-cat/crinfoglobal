                ...
                <div className='flex flex-col sm:flex-row sm:items-start sm:justify-between gap-3'>
                  <div className='flex-1'>
                    ...
                    <div className='flex flex-wrap gap-2'>
                      <Link href={`/article/${a.id}`} className='px-3 py-1 text-sm rounded bg-[#083b7a] text-white hover:bg-[#0a4ea3] transition-colors'>abstract</Link>
                      {a.pdfPath && (
                        <Link href={`/article/${a.id}`} className='px-3 py-1 text-sm rounded bg-red-600 text-white hover:bg-red-700 transition-colors'>pdf</Link>
                      )}
                      <Link href={`/article/${a.id}?tab=cite`} className='px-3 py-1 text-sm rounded bg-gray-200 hover:bg-gray-300 transition-colors'>cite</Link>
                    </div>
                  </div>
